...
| FR-007 | **Automatic Journal Analysis** | As a user, I want my journal entries to be analyzed automatically for my mental state. | The system should use local NLP/LLM processing to extract mood, stress level, and emotional tone. |
